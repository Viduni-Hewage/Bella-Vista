...
const dummyCartItems = [
  { _id: "1", product: "1", name: "Product 1", qty: 1, price: 29.99 },
  { _id: "2", product: "2", name: "Product 2", qty: 2, price: 49.99 },
];
...
const CartPage = () => {
  ...
  return (
    ...
    <div>
        <div>
            <div
                style={{width: "100%", background: "#fcf3eeff", padding: "1rem 40px 0 0", boxShadow: "0 2px 8px #f0f1f2"}}>
                <div
        ...
        <div
            style={{
                width: "100%",
                background: "linear-gradient(135deg, #562003ff, #c34c0bff)", // two colors mixed
                textAlign: "center",
                padding: "3rem 0",
                color: "white",
                fontSize: "2.5rem",
        ...
        <div style={{display: "flex", maxWidth: "1400px", margin: "3rem auto", gap: "2rem", flexDirection: window.innerWidth <= 960 ? "column" : "row", alignItems: "flex-start"  }} >    
            <div
                style={{
            ...
            >
                ...
                <div style = {{fontSize:"1.1rem"}}>
                    Your Cart Is Empty <Link to="/" style = {{color:"#9b3803ff"}}>Go Back</Link>
                </div>
                ) : (
                cartItems.map((item) => (
                    <CartItem
            ...
            >
                <div style={{ padding: "3rem 2rem 1rem 2rem", fontWeight: "400", fontSize: "1.1rem" }}>
